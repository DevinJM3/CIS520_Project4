...
##SBATCH --cpus-per-task=1
#SBATCH --nodes=2 --tasks-per-node=20
#SBATCH --ntasks=40
...
## request form.
#SBATCH --mail-user briankiralyfalvi@ksu.edu

## And finally, we run the job we came here to do.
$HOME/CIS520_Project4/3way-mpi/myscript.sh

## OR, for the case of MPI-capable jobs
#mpirun $HOME/CIS520_Project4/3way-mpi/use_mpi
#!/bin/bash
...
## And finally, we run the job we came here to do.
$HOME/CIS520_Project4/3way-pthread/myscript.sh
